...
class MergeNode : public CompositeType {
  ...
  tbb::flow::join_node<std::tuple<BigObjectPtr, BigObjectPtr, tokenn_t>, tbb::flow::reserving> join;
  using MFNode = tbb::flow::multifunction_node<std::tuple<BigObjectPtr, BigObjectPtr, tokenn_t>, std::tuple<BigObjectPtr, tokenn_t>>;
  MFNode combine;
...
void fig_17_33() {
  ...
  int src1_count = 0;
  tbb::flow::source_node<BigObjectPtr> source1{
    g,
    [&](BigObjectPtr &m) -> bool {
  ...
  int src2_count = 0;
  tbb::flow::source_node<BigObjectPtr> source2{
    g,
    [&](BigObjectPtr &m) -> bool {
  ...
  tbb::flow::function_node<BigObjectPtr> output{
    g,
    tbb::flow::serial,
    [](BigObjectPtr b) {
