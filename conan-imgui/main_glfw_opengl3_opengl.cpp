...
int main(int, char **) {
  ...
  std::cout << "framebuffer=" << framebuffer
            << " textureColorbuffer= " << textureColorbuffer << std::endl;
  ...
  while (!glfwWindowShouldClose(window)) {
    {
      ...
      glClearColor(param_color_clear.x, param_color_clear.y,
                   param_color_clear.z, param_color_clear.w);
      ...
      glClearColor(
          1.0f, 1.0f, 1.0f,
          1.0f); // set clear color to white (not really necessery actually,
...

    {
      ...
      drawList->AddImage((void *)(intptr_t)textureColorbuffer, ImVec2(0, 0),
                         ImVec2(WIDTH, HEIGHT));
    }
