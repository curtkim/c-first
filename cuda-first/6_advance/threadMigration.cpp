...
*
*   Description:
*     Simple sample demonstrating multi-GPU/multithread functionality using the CUDA Context Management API.
*     This API allows the a CUDA context to be associated with a CPU process.
*     CUDA Contexts have a one-to-one correspondence with host threads.
